...
def find_overlaps(table1: pd.DataFrame, table2: pd.DataFrame, bins: int = 100_000) -> pd.DataFrame:
    ...
    Returns:
        pd.DataFrame: DataFrame containing overlaps between the two tables.
                      Columns include 'Region1', 'Region2', 'Table1_length',
                      'Table2_length', 'Table1_coordinates', and 'Table2_coordinates'.
    Example:
